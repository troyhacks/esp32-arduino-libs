...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_lcd_ili9881c", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_lcd_touch_gt911", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_lcd_touch", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "bf3901", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_video_codec", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_video_codec", "include", "decoder"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_video_codec", "include", "decoder", "impl"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_video_codec", "include", "encoder"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_video_codec", "include", "encoder", "impl"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__gmf_audio", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_audio_codec", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_audio_codec", "include", "decoder"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_audio_codec", "include", "decoder", "impl"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_audio_codec", "include", "encoder"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_audio_codec", "include", "encoder", "impl"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_audio_codec", "include", "simple_dec"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_audio_effects", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__gmf_core", "oal", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__gmf_core", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__gmf_core", "data_bus", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__gmf_core", "helpers", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__gmf_video", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "esp_driver_ppa", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_image_effects", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "waveshare__esp_lcd_st7703", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_new_jpeg", "include"),
    ...
    CPPDEFINES=[
        ...
        ("ESP_VIDEO_VER_MAJOR", 1),
        ("ESP_VIDEO_VER_MINOR", 3),
        ("ESP_VIDEO_VER_PATCH", 1),
        ("ESP_CAM_SENSOR_VER_MAJOR", 1),
        ("ESP_CAM_SENSOR_VER_MINOR", 5),
        ("ESP_CAM_SENSOR_VER_PATCH", 2),
        ("ESP_LCD_ST7703_VER_MAJOR", 1),
        ("ESP_LCD_ST7703_VER_MINOR", 0),
        ("ESP_LCD_ST7703_VER_PATCH", 1),
        ("ESP_IPA_VER_MAJOR", 1),
        ("ESP_IPA_VER_MINOR", 2),
        ("ESP_IPA_VER_PATCH", 0),
        "ARDUINO_ARCH_ESP32",
