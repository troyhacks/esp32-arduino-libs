...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "esp_wifi", "include", "local"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "wpa_supplicant", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "wpa_supplicant", "port", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp-zboss-lib", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp-zigbee-lib", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__rmaker_common", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_diagnostics", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__cbor", "port", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_diag_data_store", "src", "rtc_store"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_diag_data_store", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_insights", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_modem", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__jsmn", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__json_parser", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__json_generator", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_schedule", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp-serial-flasher", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp-serial-flasher", "port"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_rcp_update", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_secure_cert_mgr", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_rainmaker", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__qrcode", "include"),
    ...
    LIBS=[
        "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_driver_uart", "-lapp_trace", "-lesp_event", "-lesp_driver_usb_serial_jtag", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lesp_driver_pcnt", "-lesp_driver_spi", "-lesp_driver_mcpwm", "-lesp_driver_ana_cmpr", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdmmc", "-lesp_driver_sdspi", "-lesp_driver_rmt", "-lesp_driver_tsens", "-lesp_driver_sdm_2", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_parlio", "-ldriver", "-lnvs_flash", "-lwpa_supplicant", "-lesp_wifi", "-lunity", "-lcmock", "-lconsole", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-lesp_driver_isp", "-lesp_driver_cam", "-lesp_driver_jpeg", "-lesp_driver_ppa", "-lesp_driver_touch_sens", "-lesp_eth", "-lesp_gdbstub", "-lesp_hid", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lesp_https_server", "-lesp_psram", "-lesp_lcd", "-lprotobuf-c", "-lprotocomm", "-lesp_local_ctrl", "-lespcoredump", "-lwear_levelling", "-lfatfs", "-ljson", "-lmqtt", "-lnvs_sec_provider", "-lspiffs", "-lusb", "-lwifi_provisioning", "-lespressif__esp-nn", "-lespressif__esp-tflite-micro", "-lespressif__esp_hosted", "-lespressif__esp_serial_slave_link", "-lespressif__eppp_link", "-lespressif__esp_wifi_remote", "-lespressif__network_provisioning", "-lchmorgan__esp-libhelix-mp3", "-lespressif__esp-modbus", "-lespressif__libsodium", "-lespressif__mdns", "-lespressif__esp-dsp", "-lespressif__rmaker_common", "-lespressif__esp_diagnostics", "-lespressif__cbor", "-lespressif__esp_diag_data_store", "-lespressif__esp_insights", "-lespressif__esp_modem", "-lespressif__json_parser", "-lespressif__json_generator", "-lespressif__esp_schedule", "-lespressif__esp-serial-flasher", "-lespressif__esp_rcp_update", "-lespressif__esp_secure_cert_mgr", "-lespressif__esp_rainmaker", "-lespressif__qrcode", "-ljoltwallet__littlefs", "-lfb_gfx", "-lapp_trace", "-lapp_trace", "-lcmock", "-lunity", "-lesp_driver_cam", "-lesp_driver_isp", "-lesp_driver_jpeg", "-lesp_driver_ppa", "-lesp_driver_touch_sens", "-lesp_lcd", "-lnvs_sec_provider", "-lespressif__esp-tflite-micro", "-lespressif__esp-nn", "-lm", "-lesp_hid", "-lfatfs", "-lwear_levelling", "-lspiffs", "-lusb", "-lchmorgan__esp-libhelix-mp3", "-lespressif__esp-modbus", "-lespressif__libsodium", "-lespressif__esp-dsp", "-lespressif__esp_insights", "-lespressif__esp_diagnostics", "-lespressif__cbor", "-lespressif__esp_diag_data_store", "-lespressif__esp_modem", "-lespressif__esp_rainmaker", "-lesp_local_ctrl", "-lesp_https_server", "-lwifi_provisioning", "-lespressif__network_provisioning", "-lprotocomm", "-lprotobuf-c", "-ljson", "-lespressif__mdns", "-lespressif__json_parser", "-lespressif__json_generator", "-lespressif__esp_schedule", "-lespressif__rmaker_common", "-lconsole", "-lmqtt", "-lespressif__esp_rcp_update", "-lespressif__esp-serial-flasher", "-lespressif__esp_secure_cert_mgr", "-lespressif__qrcode", "-ljoltwallet__littlefs", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_driver_uart", "-lesp_event", "-lesp_driver_usb_serial_jtag", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lesp_driver_pcnt", "-lesp_driver_spi", "-lesp_driver_mcpwm", "-lesp_driver_ana_cmpr", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdmmc", "-lesp_driver_sdspi", "-lesp_driver_rmt", "-lesp_driver_tsens", "-lesp_driver_sdm_2", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_parlio", "-ldriver", "-lnvs_flash", "-lwpa_supplicant", "-lesp_wifi", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-lesp_eth", "-lesp_gdbstub", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lesp_psram", "-lespcoredump", "-lespressif__esp_hosted", "-lespressif__esp_serial_slave_link", "-lespressif__eppp_link", "-lespressif__esp_wifi_remote", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lcore", "-lespnow", "-lnet80211", "-ltarget", "-lsmartconfig", "-lwapi", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_driver_uart", "-lesp_event", "-lesp_driver_usb_serial_jtag", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lesp_driver_pcnt", "-lesp_driver_spi", "-lesp_driver_mcpwm", "-lesp_driver_ana_cmpr", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdmmc", "-lesp_driver_sdspi", "-lesp_driver_rmt", "-lesp_driver_tsens", "-lesp_driver_sdm_2", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_parlio", "-ldriver", "-lnvs_flash", "-lwpa_supplicant", "-lesp_wifi", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-lesp_eth", "-lesp_gdbstub", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lesp_psram", "-lespcoredump", "-lespressif__esp_hosted", "-lespressif__esp_serial_slave_link", "-lespressif__eppp_link", "-lespressif__esp_wifi_remote", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lcore", "-lespnow", "-lnet80211", "-ltarget", "-lsmartconfig", "-lwapi", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_driver_uart", "-lesp_event", "-lesp_driver_usb_serial_jtag", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lesp_driver_pcnt", "-lesp_driver_spi", "-lesp_driver_mcpwm", "-lesp_driver_ana_cmpr", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdmmc", "-lesp_driver_sdspi", "-lesp_driver_rmt", "-lesp_driver_tsens", "-lesp_driver_sdm_2", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_parlio", "-ldriver", "-lnvs_flash", "-lwpa_supplicant", "-lesp_wifi", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-lesp_eth", "-lesp_gdbstub", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lesp_psram", "-lespcoredump", "-lespressif__esp_hosted", "-lespressif__esp_serial_slave_link", "-lespressif__eppp_link", "-lespressif__esp_wifi_remote", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lcore", "-lespnow", "-lnet80211", "-ltarget", "-lsmartconfig", "-lwapi", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_driver_uart", "-lesp_event", "-lesp_driver_usb_serial_jtag", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lesp_driver_pcnt", "-lesp_driver_spi", "-lesp_driver_mcpwm", "-lesp_driver_ana_cmpr", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdmmc", "-lesp_driver_sdspi", "-lesp_driver_rmt", "-lesp_driver_tsens", "-lesp_driver_sdm_2", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_parlio", "-ldriver", "-lnvs_flash", "-lwpa_supplicant", "-lesp_wifi", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-lesp_eth", "-lesp_gdbstub", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lesp_psram", "-lespcoredump", "-lespressif__esp_hosted", "-lespressif__esp_serial_slave_link", "-lespressif__eppp_link", "-lespressif__esp_wifi_remote", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lcore", "-lespnow", "-lnet80211", "-ltarget", "-lsmartconfig", "-lwapi", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_driver_uart", "-lesp_event", "-lesp_driver_usb_serial_jtag", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lesp_driver_pcnt", "-lesp_driver_spi", "-lesp_driver_mcpwm", "-lesp_driver_ana_cmpr", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdmmc", "-lesp_driver_sdspi", "-lesp_driver_rmt", "-lesp_driver_tsens", "-lesp_driver_sdm_2", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_parlio", "-ldriver", "-lnvs_flash", "-lwpa_supplicant", "-lesp_wifi", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-lesp_eth", "-lesp_gdbstub", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lesp_psram", "-lespcoredump", "-lespressif__esp_hosted", "-lespressif__esp_serial_slave_link", "-lespressif__eppp_link", "-lespressif__esp_wifi_remote", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lcore", "-lespnow", "-lnet80211", "-ltarget", "-lsmartconfig", "-lwapi", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_driver_uart", "-lesp_event", "-lesp_driver_usb_serial_jtag", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lesp_driver_pcnt", "-lesp_driver_spi", "-lesp_driver_mcpwm", "-lesp_driver_ana_cmpr", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdmmc", "-lesp_driver_sdspi", "-lesp_driver_rmt", "-lesp_driver_tsens", "-lesp_driver_sdm_2", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_parlio", "-ldriver", "-lnvs_flash", "-lwpa_supplicant", "-lesp_wifi", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-lesp_eth", "-lesp_gdbstub", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lesp_psram", "-lespcoredump", "-lespressif__esp_hosted", "-lespressif__esp_serial_slave_link", "-lespressif__eppp_link", "-lespressif__esp_wifi_remote", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lcore", "-lespnow", "-lnet80211", "-ltarget", "-lsmartconfig", "-lwapi", "-lc", "-lm", "-lstdc++", "-lpthread", "-lnewlib", "-lgcc", "-lcxx"
    ],
